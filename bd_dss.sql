...
--
-- Estructura de tabla para la tabla `cuponescomprados`
--
...
--
-- Volcado de datos para la tabla `cuponescomprados`
--

INSERT INTO `cuponescomprados` (`idCupon`, `idOferta`, `DuiCliente`, `estado`) VALUES
...
INSERT INTO `empresa` (`CodigoEmpresa`, `nombre`, `direccion`, `telefono`, `correo`, `idRubro`, `comision`, `logo`) VALUES
('EM001', 'Restaurante Doña Rosa', '3a Avenida Norte 7 C, San Salvador', '2262-8475', 'DoniaRosa@gmail.com', 1001, 7, 'RosiLogo.jpg'),
('EM002', 'Gq Racing Sport', 'Blvr. Sta. Elena 20', '2535-0203', 'TallerGQ@gmail.com', 1002, 8.5, 'GQlogo.jpeg'),
('EM003', 'ZOOVET', 'Avenida Albert Einstein 1', '7050-9654', 'zoovet@gmail.com', 1004, 12, 'ZOOVETlogo.jpg'),
('EM004', 'Tony Romas', 'Blvr. del Hipódromo 777, San Salvador', '2298-5050', 'TonyRomas@gmail.com', 1001, 5.2, 'TR_logo.png'),
('EM005', 'Atami beach house', 'Calle Los Conacastes, poligono i, lote 1, club atami, La Libertad, El Salvador', '2296-2569', 'atamibeach@gmail.com', 1006, 15.2, 'AtamiLogo.png'),
('EM006', 'El Espíritu de la Montaña', 'Conchagua', '7484-9950', 'EspiritudMontania@gmail.com', 1005, 8.9, 'EspirituMlogo.png'),
('EM007', 'Las Hojas Resort & Beach Club', 'alle Principal 95 Playa Las Hojas, San Pedro', '2505-2800', 'LasHojasResort@gmail.com', 1006, 9.5, 'LasHojasLogo.webp'),
('EM008', 'El Pinabete La Montaña de Los Sueños', 'Canton las granadillas, La Palma La Palma, Chalatenango ', '0016-8000', 'pinabete@gmail.com', 1006, 8.5, 'ELPinabeteLogo.jpg'),
('EM009', 'Clínica Psicológica INFICON', '9 Calle Poniente Bis #4927 Colonia Escalón. Clínica Psicológica INFICON.', '', 'infisionClinic@gmail.com', 1003, 9, 'ClinicaInficonLogo.jpg'),
('EM010', 'Talleres G2', 'Calle a San Antonio abad, pasaje Valdivieso #9-a, San Salvador San Salvador, El Salvador', '2522-4335', 'tallerg2@gmail.com', 1002, 12.5, 'G2Logo.jpg');
...
INSERT INTO `oferta` (`CodigoOferta`, `titulo`, `precioRegular`, `precioOferta`, `fechaInicio`, `fechaFin`, `cantidadLimite`, `descripcion`, `idEmpresa`, `fechaLimite`, `CantidadVenta`, `estado`, `img`, `categoria`) VALUES
('OF001', 'Banquete para 5', 30.5, 19.99, '2023-02-24', '2023-02-28', 55, 'Banquete familiar para 5 personas', 'EM001', '2023-03-10', 54, 1, 'RosiBanquete5.jpg', 'Restaurante'),
('OF002', 'Cambio de aceite', 25, 15, '2023-02-24', '2023-03-10', 0, 'Cambio de aceite', 'EM002', '2023-03-31', 0, 0, 'GQcambio_de_aceite.jpg', 'Automotriz'),
('OF003', 'Baño y corte de pelo', 32.99, 21.99, '2023-02-24', '2023-03-31', 200, 'Baño para su mascota mas corte de pelo', 'EM003', '2023-04-27', 0, 0, 'ZOOVETcortePelo.jpg', 'Salud'),
('OF004', 'Banquete de RIBS para 5 personas', 65.99, 45, '2023-02-24', '2023-03-14', 80, 'Banquete de RIBS para 5 personas !!!', 'EM004', '2023-02-21', 0, 1, 'TRbanquete.jpg', 'Restaurante'),
('OF005', 'Day pass', 25, 10.99, '2023-02-24', '2023-03-08', 90, 'Day pass Totalmente consumible a su valor original ($25.00)', 'EM005', '2023-03-22', 0, 1, 'AtamiDaypass.png', 'Diversion'),
('OF006', 'Cabaña mas kit para fogata', 125.99, 75, '2023-02-24', '2023-03-08', 25, 'Paquete que incluye estancia en cabaña para 4 personas mas un kit para fogata Incluye una glorieta', 'EM006', '2023-03-31', 0, 0, 'EspirituM _kit_fogata.png', 'Diversion'),
('OF007', 'Day pass Consumible', 25, 15, '2023-02-24', '2023-03-15', 100, 'Day pass consumible a su precio original ($25.00)', 'EM007', '2023-03-31', 0, 0, 'LasHojasDaypass.jpg', 'Diversion'),
('OF008', 'Cabaña para 4 personas', 95, 45, '2023-02-24', '2023-03-16', 50, 'Cabaña para 4 personas', 'EM008', '2023-03-31', 0, 0, 'ElPinabete4Personas.jpg', 'Diversion'),
('OF009', 'Terapia Psicologica', 35, 17.99, '2023-02-24', '2023-03-15', 50, 'Paga $17.99 en lugar de $35 por una sesión de Terapia Psicológica', 'EM009', '2023-03-31', 0, 0, 'ClinicaInficonTerapia.jpg', 'Salud'),
('OF010', 'Cambio de discos de freno', 35, 19.99, '2023-02-24', '2023-03-16', 60, 'Oferta en el cambio de discos de freno', 'EM010', '2023-03-31', 0, 0, 'G2DiscosdeFrenos.jpg', 'Automotriz');
...
(1002, 'Automotriz', 'Este rubro esta orientado a las empresas de la rama relacionada con los automoviles'),
...
--
-- Filtros para la tabla `cuponescomprados`
--
ALTER TABLE `cuponescomprados`
  ADD CONSTRAINT `cuponescomprados_ibfk_1` FOREIGN KEY (`idOferta`) REFERENCES `oferta` (`CodigoOferta`),
  ADD CONSTRAINT `cuponescomprados_ibfk_2` FOREIGN KEY (`DuiCliente`) REFERENCES `cliente` (`DUI`);
